    ...
    <div className="sidebar">
      ...
      <div className="sidebar-bottom">
        <div
          ...
          style={{ cursor: 'pointer', borderRadius: 9, transition: 'background .15s' }}
        ...
        >
          ...
          <div>
            ...
            <div className="user-role" style={{ color: view === 'profile' ? '#60A5FA' : undefined }}>
              {view === 'profile' ? '← Profil aktif' : 'Klik untuk edit profil'}
            </div>
          </div>
        </div>
